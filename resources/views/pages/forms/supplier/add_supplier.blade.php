                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('supplier.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="supplier_code" type="text" class="form-control @error('supplier_code') is-invalid @enderror" name="supplier_code" value="{{ old('supplier_code') }}" autocomplete="supplier_code" autofocus>
