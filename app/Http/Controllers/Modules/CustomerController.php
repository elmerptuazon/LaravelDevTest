...
class CustomerController extends Controller
{
    ...
    {
        $customers = Customer::paginate(config('page_number.items_per_page'));
    ...
    public function renderAddCustomerForm() {
        $countries = Country::get();
       return view("pages.forms.customer.add_customer", ['countries'=>$countries]);
    }
